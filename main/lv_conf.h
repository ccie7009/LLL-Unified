 ...
 * Configured for ESP32-S3 + ST7789P3 76x284 display
 */
...
/* Swap the 2 bytes of RGB565 color. Useful if the display has an SPI/parallel port and
 * the color is sent via byte(s). Fix for ST7789P3 color channel order. */
 ...
 * 0: round down, 64: round up from x.75, 128: round up from half, 192: round up from x.25, 255: round up */
...
#define LV_USE_BIDI 0
     ...
     * `LV_BASE_DIR_AUTO` detect based on the content */
